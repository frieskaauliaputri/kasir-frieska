                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if(Auth::user()->role === 'admin') 
                                <td>
                                    <a href="{{ route('product.edit', $product->id) }}" class="btn btn-warning"><i class="mdi mdi-tooltip-edit"></i>Edit</a>
                                    ...
                                    <form action="{{ route('product.delete', $product->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus produk ini?')"><i class="mdi mdi-delete"></i>Delete</button>
                                    </form>
                                </td>
                                @endif
                            </tr>
