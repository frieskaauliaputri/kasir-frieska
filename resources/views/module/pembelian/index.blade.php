                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-around">
                                                <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#lihat-{{$sale->id}}"><i class="mdi mdi-eye"></i>Lihat</button>
                                                <a href="{{ route('download', $sale->id) }}" class="btn btn-info"><i class="mdi mdi-download"></i>Unduh Bukti</a>
                                            </div>
                                        </td>
                                    </tr>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row mb-3 text-center mt-5">
                                                        <div class="col-3"><b>Nama Product</b></div>
                                                        <div class="col-3"><b>Quantityy</b></div>
